...
@section('content')
    <div class="container-fluid mt-11">
        ...
        <ul class="nav nav-pills gap-2 justify-content-center" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="btn btn-sm text-white " id="diverse-tab" data-bs-toggle="tab"
                    data-bs-target="#diverse" type="button" role="tab" aria-controls="diverse"
                    aria-selected="false">منوعات</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="btn btn-sm btn-outline-light rounded-pill" id="world-tab" data-bs-toggle="tab"
                    data-bs-target="#world" type="button" role="tab" aria-controls="world" aria-selected="false">فن و
                    ثقافة</button>
            </li>
            <li class="nav-item" role="presentation">
            ...
            <li class="nav-item" role="presentation">
                <button class="btn btn-sm btn-outline-light rounded-pill" id="society-tab" data-bs-toggle="tab"
                    ...
                    aria-selected="false">اقتصاد</button>
            </li>
            <li class="nav-item" role="presentation">
...
<div class="container-fluid px-4 text-end">
    ...
    <div class="mt-3 text-start">
        <a href="{{ 'trending' }}" class="btn btn-light fw-bold text-decoration-none">اكتشف اكثر</a>
            ...
            <div class="container tab-pane fade show active " id="politic" role="tabpanel" aria-labelledby="politic-tab">
                <div class="row p-4">
                    <div class="col-sm-12">
                                            ...
                                            <a href="{{ 'imagenews' }}" class="text-decoration-none">
                                                <div class="card bg-dark text-white card-equal">
                                                    ...
                                                    <div class="card-img-overlay d-flex flex-column justify-content-end">
                                                        <h5 class="card-title text-white">"الانضباط" تسدل الستار على ملف
                                                            عقوبة هويسين</h5>
                                                    </div>
                                                </div>
                                            </a>
